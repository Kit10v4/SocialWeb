        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none border border-gray-200 rounded-xl text-sm p-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="text-sm px-3 py-2 rounded-md border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
