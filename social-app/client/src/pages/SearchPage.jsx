      ...
      <div className="max-w-2xl mx-auto px-4 py-8 sm:py-10">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-10 py-3.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl text-sm text-gray-900 dark:text-gray-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition placeholder:text-gray-400 dark:placeholder:text-gray-500"
          />
          {query && (
            <button
              onClick={() => setQuery("")}
...
function AddFriendButton({ state, onClick }) {
  ...
  if (state === "sending") {
    return (
      <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-50 dark:bg-blue-900/30 text-blue-400 text-xs font-semibold cursor-default select-none">
